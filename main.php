...
<head>
    ...
    <style>
        ...
        .cake h1 a, .mexican-food h1 a, .savory-food h1 a, .momo-food h1 a
        {
            color: #603A68;
            font-size: 45px
        }
        .cake-det, .mexi-det, .sav-det, .momo-det
        {
            display: flex;
            height: 100%;
            margin-bottom: 5%;
        ...
        .cake-det h2 a, .mexi-det h2 a, .sav-det h2 a, .momo-det h2 a
        {
            color: #603A68;
        }
        .cake h1 a:hover, .mexican-food h1 a:hover, .savory-food h1 a:hover, .momo-food h1 a:hover, .cake-det h2 a:hover, .mexi-det h2 a:hover, .sev-det h2 a:hover, .momo-det h2 a:hover 
        {
            color: #35CD57;
        }
        ...
        .mexi-det h2, .sav-det h2, .momo-det h2
        {
           color: #603A68;
           padding-top: 60%;
           padding-left: 150px;
       ...
       .mexi-det h4, .sav-det h4, .momo-det h4
       {
            width: 60px;
            height: 60px;
            padding-top: 14px;
        ...
        .cake-det .food-image, .mexi-det .food-image, .sav-det .food-image, .momo-det .food-image
        {
            width:200px;
            height:200px;
            margin: auto;
...
<section class="main container">
    <div class="food-service">
        <div class="cake">
            <h1><a href="cake-det.php">Cake </a></h1>
            <p>If You Want show more Cake. <b style="color: #15B295;">Click on Cake.</b></p>
            <hr style="border: 0.5px dotted #000;">
            <div class="cake-det">
                <div class="col-lg-4">

                    <?php 
                           $con=mysqli_connect("localhost","root","","tastytreat");
                        ...
                        <?php 
                            ...
                            ?>
                        <img class="food-image" alt="" src="<?php echo $row['image']; ?>" > 
                    ...
                    <div class="btnt">
                    <div class="col-sm-6">
                    <a class="btn btn-primary"  href="cartp.php">Add Cart</a>
                    </div>
                    <div class="col-sm-6">
                    <a class="btn btn-success" href="buy.php?edit=<?php echo $row['id']; ?>">Buy Online</a>
                    </div>
                    </div>
                    <?php } } ?>
                </div>
                ...
                <div class="col-lg-4">
                    <?php 
                        ...
                        <?php 
                            ...
                            $query = "SELECT * FROM cake  WHERE id=2";
                            $read = mysqli_query($con,$query);
                            if (mysqli_num_rows($read)>0) 
                            {
                                while ($row=mysqli_fetch_array($read)) {
                            ...
                            ?>
                    <img src="<?php echo $row['image']; ?>" class="food-image" alt="">
                    <h2><?php echo $row['title']; ?></h2>
                    <table>
                    <tr>
                        <th><?php echo $row['size']; ?></th>
                        <th><?php echo $row['size1']; ?></th>
                        <th><?php echo $row['size2']; ?></th>
                    </tr>
                    <tr>
                        <td><?php echo $row['price']; ?>৳</td>
                        <td><?php echo $row['price1']; ?>৳</td>
                    ...
                    <div class="btnt" style="display: flex;">
                    <div class="col-sm-6">
                    <a class="btn btn-primary"  href="cartp.php?edit=<?php echo $row['id']; ?>">Add Cart</a>
                    </div>
                    <div class="col-sm-6">
                    <a class="btn btn-success" href="buy.php?edit=<?php echo $row['id']; ?>">Buy Online</a>
                    </div>
                ...
                <div class="col-lg-4">
                    <?php 
                        ...
                        <?php 
                            ...
                            $query = "SELECT * FROM cake  WHERE id=3";
                            $read = mysqli_query($con,$query);
                            if (mysqli_num_rows($read)>0) 
                            {
                                while ($row=mysqli_fetch_array($read)) {
...
<hr>
        ...
        <div class="mexican-food">
            <h1><a href="#">Mexican Food</a></h1>
            <p>Show More, <b>Click on Mexican Food</b></p>
            <hr style="border: 0.5px dotted #000;">
            <div class="mexi-det">
                <div class="col-lg-4">
                    <?php 
                        ...
                        <?php 
                            ...
                            $query = "SELECT * FROM cake  WHERE id=19";
                            $read = mysqli_query($con,$query);
                            if (mysqli_num_rows($read)>0) 
                            {
                                while ($row=mysqli_fetch_array($read)) {
                ...
                <div class="col-lg-4">
                    <?php 
                        ...
                        <?php 
                            ...
                            $query = "SELECT * FROM cake  WHERE id=20";
                            $read = mysqli_query($con,$query);
                            if (mysqli_num_rows($read)>0) 
                            {
                                while ($row=mysqli_fetch_array($read)) {
                ...
                <div class="col-lg-4">
                    <?php 
                        ...
                        <?php 
                            ...
                            $query = "SELECT * FROM cake  WHERE id=21";
                            $read = mysqli_query($con,$query);
                            if (mysqli_num_rows($read)>0) 
                            {
                                while ($row=mysqli_fetch_array($read)) {
...
<hr>
        ...
        <div class="savory-food">
            <h1><a href="#">Savory</a></h1>
            <p>Show More,<b>Click On Savory</b></p>
            <hr style="border: 0.5px dotted #000;">
            <div class="sav-det">
                <div class="col-lg-4">
                    <?php 
                        ...
                        <?php 
                            ...
                            $query = "SELECT * FROM cake  WHERE id=22";
                            $read = mysqli_query($con,$query);
                            if (mysqli_num_rows($read)>0) 
                            {
                                while ($row=mysqli_fetch_array($read)) {
                ...
                <div class="col-lg-4">
                    <?php 
                        ...
                        <?php 
                            ...
                            $query = "SELECT * FROM cake  WHERE id=23";
                            $read = mysqli_query($con,$query);
                            if (mysqli_num_rows($read)>0) 
                            {
                                while ($row=mysqli_fetch_array($read)) {
                ...
                <div class="col-lg-4">
                    <?php 
                        ...
                        <?php 
                            ...
                            $query = "SELECT * FROM cake  WHERE id=24";
                            $read = mysqli_query($con,$query);
                            if (mysqli_num_rows($read)>0) 
                            {
                                while ($row=mysqli_fetch_array($read)) {
...
<hr>
        ...
        <div class="momo-food">
            <h1><a href="#">Momo, Burger & Pizza</a></h1>
            <p>Show More,<b>Click On Momo, Burger & Pizza</b></p>
            <hr style="border: 0.5px dotted #000;">
            <div class="momo-det">
                <div class="col-lg-4">
                    <?php 
                        ...
                        <?php 
                            ...
                            $query = "SELECT * FROM cake  WHERE id=25";
                            $read = mysqli_query($con,$query);
                            if (mysqli_num_rows($read)>0) 
                            {
                                while ($row=mysqli_fetch_array($read)) {
                ...
                <div class="col-lg-4">
                   <?php 
                        ...
                        <?php 
                            ...
                            $query = "SELECT * FROM cake  WHERE id=26";
                            $read = mysqli_query($con,$query);
                            if (mysqli_num_rows($read)>0) 
                            {
                                while ($row=mysqli_fetch_array($read)) {
                ...
                <div class="col-lg-4">
                    <?php 
                        ...
                        <?php 
                            ...
                            $query = "SELECT * FROM cake  WHERE id=27";
                            $read = mysqli_query($con,$query);
                            if (mysqli_num_rows($read)>0) 
                            {
                                while ($row=mysqli_fetch_array($read)) {
