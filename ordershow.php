    ...
    <tbody>
      <?php while ($row = mysqli_fetch_array($results)) {?>
        <tr>
          ...
          <td>
            <a class="btn btn-danger" onclick="return confirm ('Want to Delete!');" href="server3.php?del=<?php echo $row['id']; ?>">Remove</a>
          </td>
          <td>
            <a class="btn btn-info" onclick="return confirm ('Order Complete!');" href="https://tastyt.000webhostapp.com/conformation.php">Conformation Mail</a>
          </td>
        </tr>
      <?php } ?>
