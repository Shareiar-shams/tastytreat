...
<head>
	...
	<link rel="icon" href="images/YVSOn3yfOhLKts45byd9.png" type="image/png">
		<title>Photo Gallery - Tasty Treat</title>
    <meta name="description" content="photo gallery meta description">
...
<!--================ Start Banner Area =================-->
<section class="banner_area photo_banner_area mt-80">
	<div class="container">
...
<section class="photo_gallery_area">
	<div class="container">
		<div class="row justify-content-center">
												<div class="col-lg-4 col-md-6 col-sm-6 col-10">
						<div class="single_photo">
							<figure>
								<img class="img-fluid w-100" src="images/burger_potate_slice.jpg" alt="">
							</figure>
							<div class="overlay overlay_bg"></div>
							<a href="images/burger_potate_slice.jpg" class="photo-gallery-pop-up">
								<div class="middle">
									<div class="wrap_icon">
						...
						<div class="single_photo">
							<figure>
								<img class="img-fluid w-100" src="images/pizza_slice2.jpg" alt="">
							</figure>
							<div class="overlay overlay_bg"></div>
							<a href="images/pizza_slice2.jpg" class="photo-gallery-pop-up">
								<div class="middle">
									<div class="wrap_icon">
										<span class="fa fa-arrows-h"></span>
									</div>
						...
						<div class="single_photo">
							<figure>
								<img class="img-fluid w-100" src="images/fry_chiken_peach.jpg" alt="">
							</figure>
							<div class="overlay overlay_bg"></div>
							<a href="images/fry_chiken_peach.jpg" class="photo-gallery-pop-up">
								<div class="middle">
									<div class="wrap_icon">
										<span class="fa fa-arrows-h"></span>
									</div>
						...
						<div class="single_photo">
							<figure>
								<img class="img-fluid w-100" src="images/cup_sen.jpg" alt="">
							</figure>
							<div class="overlay overlay_bg"></div>
							<a href="images/cup_sen.jpg" class="photo-gallery-pop-up">
								<div class="middle">
									<div class="wrap_icon">
										<span class="fa fa-arrows-h"></span>
									</div>
						...
						<div class="single_photo">
							<figure>
								<img class="img-fluid w-100" src="images/single_chiken_burger.jpg" alt="">
							</figure>
							<div class="overlay overlay_bg"></div>
							<a href="images/single_chiken_burger.jpg" class="photo-gallery-pop-up">
								<div class="middle">
									<div class="wrap_icon">
										<span class="fa fa-arrows-h"></span>
									</div>
						...
						<div class="single_photo">
							<figure>
								<img class="img-fluid w-100" src="images/double_chiken_burger.jpg" alt="">
							</figure>
							<div class="overlay overlay_bg"></div>
							<a href="images/double_chiken_burger.jpg" class="photo-gallery-pop-up">
								<div class="middle">
									<div class="wrap_icon">
										<span class="fa fa-arrows-h"></span>
									</div>
