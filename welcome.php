...
<head>
	...
	<!-- main css -->
        ...
        <style type="text/css">
            ...
            .user_id a:hover, .subscribe_id a:hover, .cake_id a:hover
            {
                color: #233385;
            }
        </style>
...
<section class="user-loging container">
    <div class="user_id">
	<h2>Customer ID</h2>
    <p>Want to see Customer Registration Table <b><a href="user_table.php"> Click Here </a></b></p>
    <hr style="border: 1px dotted #000;">
    </div>

    <div class="subscribe_id">
    <h2>SubsCriber ID</h2>
    <p>Want to see Customer Subscriber table <b><a href="subscribe_table.php"> Click Here </a></b></p>
    <hr style="border: 1px dotted #000;"> 
    </div>

    <div class="cake_id">
        <h2>Cake</h2>
        <p>You want Dynamic Cake Catagory Then <a href="chack.php">Click Here</a></p>
        <hr style="border: 1px dotted #000;"> 
    </div>

    <div class="cake_id">
        <h2>Chack Order</h2>
        <p>See The Order Request List. Then <a href="orderrequest.php">Click Here</a></p>
        <hr style="border: 1px dotted #000;"> 
    </div>

    <div class="cake_id">
        <h2>Order Delivery List</h2>
        <p>See The Order delivery List. Then <a href="ordershow.php">Click Here</a></p>
        <hr style="border: 1px dotted #000;"> 
    </div>
