...
<head>
	...
	<link rel="icon" href="images/YVSOn3yfOhLKts45byd9.png" type="image/png">
		<title>Contact Us - Tasty Treat</title>
    <meta name="description" content="contact page meta desc">
...
<!--================ Start Banner Area =================-->
<section class="banner_area contact_banner_area mt-80">
    <div class="container">
...
<!--================ Start Contact Area =================-->
<section class="contact mt-60 mb-100">
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <div class="single_contact_address d-flex">
                    <div>
                        <i class="fa fa-home"></i>
                    </div>
                    <div class="info">
                        <h3>PRAN-RFL Centre</h3>
                        <p>105, Progoti Sarani Middle Badda</p>
                        <p>Dhaka 1212, Bangladesh</p>
                        <p>Phone: 09613-737777</p>
                    </div>
                </div>
            ...
            <div class="col-lg-8">
                ...
                <div class="post-form mt-50">
            <form action="/contact" method="post">
        <input type="hidden" name="_token" value="VPpc81MYGQiQaSd1Lx5EGczyDhQp0pjkCWHKJt4I">
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group">
                    <input  type="text" class="form-control" value="" class="form-control" id="name" name="name" placeholder="Name" required>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
        ...
        <div class="mt-20">
            <button type="submit" class="primary_btn2 text-capitalize">send message</button>
        </div>
    </form>
</div>            </div>
        </div>
            ...
            <div class="col-lg-9">
                <div class="footer-bottom text-center d-flex justify-content-between">
                    ...
                    <div class="footer-social d-flex align-items-center justify-content-center">
                        <a target="_blank" href="https://www.facebook.com/tastytreatbd/"><i class="fa fa-facebook"></i></a>

    <a target="_blank" href="https://www.instagram.com/tastytreatbd/"><i class="fa fa-instagram"></i></a>

    <a target="_blank" href="https://www.youtube.com/channel/UC-n4N7Ssg4FgjuMrrMv17kw"><i class="fa fa-youtube"></i></a>
    ...
    (function ($) {
        ...
        if (document.getElementById('contactMap')) {
            map = new google.maps.Map(document.getElementById('contactMap'), {
                zoom: 14,
                center: new google.maps.LatLng(23.781400, 90.425461),
