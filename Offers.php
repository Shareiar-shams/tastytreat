...
<head>
	...
	<link rel="icon" href="images/YVSOn3yfOhLKts45byd9.png" type="image/png">
		<title>Offers - Tasty Treat</title>
    <meta name="description" content="menu page meta description">
		...
		header .main_menu .navbar
{
	background:#30525E;
		...
		.banner_area.menu_banner_area {
			background: url('images/uIQKeaECbMkB4ThY0NhZ.jpg') no-repeat center;
		}
	</style>
	<!-- Google Tag Manager -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="owl-carousel owl-theme" id="image-menu-owl">
                            ...
                            <h5>Cake</h5>
                            <a href="cake.php" class="overlay"></a>
                        </div>
                                            <div class="single_item image_menu_bg_10">
                            ...
                            <a href="#" class="overlay"></a>
                                            ...
                                            <div class="single_item image_menu_bg_10">
                            <img src="images/kOx3RnOAAXI2hEFlBBsB.png" class="img-fluid" alt="">
...
<!--================  Start Set Menu Area =================-->
<section class="set_menu_area">
	<div class="container">
		<div class="row">
			    								<div class="col-lg-4 col-md-6">
						<div class="single_set_menu">
							<figure>
								<img class="img-fluid w-100" src="images/SrsEKLkwTMMKqL19Vn2i.jpg" alt="">
							</figure>
							<h3 class="bottom_link">Cake</h3>
							<a href="main.php" class="overlay"></a>
						</div>
					</div>
									<div class="col-lg-4 col-md-6">
						<div class="single_set_menu">
							<figure>
								<img class="img-fluid w-100" src="images/pEbify9RpMk4DaflkXlj.jpg" alt="">
							</figure>
							<h3 class="bottom_link">Mexican</h3>
							<a href="#mexican" class="overlay"></a>
						</div>
					</div>
									<div class="col-lg-4 col-md-6">
						<div class="single_set_menu">
							<figure>
								<img class="img-fluid w-100" src="images/XbeCTxoDF4feh8IOPist.jpg" alt="">
							</figure>
							<h3 class="bottom_link">Savory</h3>
						...
						<div class="single_set_menu">
							<figure>
								<img class="img-fluid w-100" src="images/QTa6lc8VmPNiMZL5qUCa.jpg" alt="">
							</figure>
							<h3 class="bottom_link">Dessert And Pastry</h3>
							<a href="#dessert-and-pastry" class="overlay"></a>
						</div>
					</div>
									<div class="col-lg-4 col-md-6">
						<div class="single_set_menu">
							<figure>
								<img class="img-fluid w-100" src="images/14qSx51UOyz0WdnQDow5.jpg" alt="">
							</figure>
							<h3 class="bottom_link">Drinks</h3>
							<a href="#drinks" class="overlay"></a>
						</div>
					</div>
									<div class="col-lg-4 col-md-6">
						<div class="single_set_menu">
							<figure>
								<img class="img-fluid w-100" src="images/QnPKiyP47skQ4i6qWCVy.jpg" alt="">
							</figure>
							<h3 class="bottom_link">Chicken</h3>
							<a href="#chicken" class="overlay"></a>
						</div>
					</div>
									<div class="col-lg-4 col-md-6">
						<div class="single_set_menu">
							<figure>
								<img class="img-fluid w-100" src="images/YX6u5dFfOaisemQ9suL9.jpg" alt="">
							</figure>
							<h3 class="bottom_link">Momo</h3>
							<a href="#momo" class="overlay"></a>
						</div>
					</div>
									</div>
